...
export LD_LIBRARY_PATH="$HOME/custom_software/openmpi-3.0.0/lib:$HOME/custom_software/boost_1_55_0/lib:$HOME/custom_software/jsoncpp/libs/linux-gcc-4.4.7:$HOME/custom_software/hdf5-1.8.19/hdf5/lib:$LD_LIBRARY_PATH"
